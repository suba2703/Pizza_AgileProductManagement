...
namespace Pizza_Order
{
    public partial class OrderForm : Form
    {
        ...
        public OrderForm()
        {
            orderInvoice = new OrderInvoiceForm();
            InitializeComponent();
        ...
        private void SpeakControlsLeftToRight(Control parentControl)
        {
            var sortedControls = parentControl.Controls.Cast<Control>()
        .OrderBy(c => c.Top )
        .ToList();
            ...
            foreach (Control control in sortedControls)
            {
                ...
                {
                    string textToSpeak = control.Text;
                ...
                // Recursively process child controls, maintaining left-to-right order
                SpeakControlsLeftToRight(control);
            }
        }
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            if (PersonalRadioButton.Checked == true)
            {
                ...
                orderInvoice.SubTotalListView.Items.Add(item);
                orderInvoice.quantity = Convert.ToInt32(NumericquantityValue.Value);
                orderInvoice.quantityOrder.Value = orderInvoice.quantity;
           ...
           orderInvoice.Show(); // Shows the order invoice form because it is already instantiated
        ...
        private void OrderForm_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
        ...
        private void BuildOwnGroupBox_Enter(object sender, EventArgs e)
        {
